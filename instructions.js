		...
		timeline: [
			{
				...
				תשובה נכונה תסומן בירוק. תשובה לא נכונה תסומן באדום ומיד תראה/י את התשובה הנכונה מסומנת בירוק.<br>\
				תזכורת: כדי שתוכל/י להתחיל במשחק יש לענות נכונה על כל השאלות.\
				אם לא עונים על הכל נכון פשוט חוזרים על ההוראות ואז שוב על השאלות.<br><br>\
				לחצ/י על התחל כדי לעבור לשאלות.<br>\
				</p>',
			}
		]
	};
