...
window.app_settings = {
	...
	instructions_test_questions: {
		...
		2: {
			question: 'האם הסיכויים למצוא זהב משתנה בפרקי זמן מסויימים במשחק?',
			correct_answer: 'לא, הסיכויים לא משתנים לאורך ימי המשחק.',
			distractor_1: 'הסיכוי למצוא זהב משתנה כל יום.',
			distractor_2: 'הסיכוי למצוא זהב משתנה כשמעונן ואין אפשרות לראות אם מצאנו זהב.',
			distractor_3: 'אם בכניסות האחרונות מצאנו הרבה פעמים זהב אין סיכוי למצוא עוד זהב.',
		},
		3: {
		...
		8: {
			question: 'כיצד אוכל לזכות בחולצה?',
			correct_answer: 'פשוט להיכנס לאפליקציה כדי לחפש זהב. במידה ומצאתי זהב ויש מקום במחסן, הזהב יילקח לכדור הארץ ויגדיל את סיכויי לזכות. ככל שאצבור יותר זהב סיכויי לזכות יגדלו.',
			distractor_1: 'אין אפשרות לזכות במשהו במשחק.',
			distractor_2: 'פשוט להיכנס לאפליקציה כדי לחפש אבנים. במידה ומצאתי אבנים ויש מקום במחסן, האבנים יילקחו לכדור הארץ ויגדילו את סיכויי לזכות.',
			distractor_3: 'להיכנס לאפליקציה ולהמתין בה זמן רב ככל שניתן לפני שאסגור אותה. ככל שהיא פתוחה יותר זמן ברצף, סיכויי יגדלו.',
		},
		9: {
		...
		10: {
			...
			correct_answer: 'משך המשחק אינו קבוע מראש. הוא אורך בין ימים אחדים לשבוע.',
